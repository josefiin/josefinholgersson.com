...
const ButtonSm = (props: ButtonSmProps) => {
  ...
  const classes = classNames(
    'text-xl w-fit h-12 flex gap-4 items-center justify-center border-2 border-foreground rounded-full px-6 hover:bg-decoration transition-colors duration-300 ease-in-out',
    className,
  );
